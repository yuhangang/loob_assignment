...
class CartItem {
  ...
  /// Whether any selected option is unavailable at the current store.
  bool get hasUnavailableOptions =>
      selectedOptions.any((o) => !o.isAvailable);

  /// Names of selected options that are currently unavailable.
  List<String> get unavailableOptionNames =>
      selectedOptions.where((o) => !o.isAvailable).map((o) => o.name).toList();
