          ...
          child: ClipRRect(
            ...
            child: BackdropFilter(
              ...
              child: Material(
                ...
                child: InkWell(
                  onTap: () {
                    AppRouter.navigatorKey.currentState?.pushNamed(AppRouter.vouchers);
                  },
                  borderRadius: BorderRadius.circular(AppSpacing.radiusFull),
                  child: Container(
            ...
            child: Row(
              children: [
                      ...
                      if (cartState.hasUnavailableItems)
                        ...
                        Text(
                          cartState.totalPrice
                              .toDisplayPrice(cartState.currency),
                ...
                FilledButton(
                  ...
                  onPressed: () {
                    AppRouter.navigatorKey.currentState?.pushNamed(AppRouter.cart);
                  },
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
